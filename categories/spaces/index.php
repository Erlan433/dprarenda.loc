<?php
    ...
    if(isset($_POST["seek"])){
        $search = $_POST["search"];
        $sql = "SELECT * FROM rooms WHERE category = 3 AND title LIKE '%$search%'";
    } else {
...
<head>
    ...
    <link rel="stylesheet" href="/css/home/categories/spaces.css?m=<?php echo rand() ?>">
